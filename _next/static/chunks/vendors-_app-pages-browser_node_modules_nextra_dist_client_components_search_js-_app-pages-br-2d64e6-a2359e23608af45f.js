...
let D = {
    ...
    [2] (t, i) {
        ...
        if (t.virtual) {
            let { options: p, disabled: s } = t.virtual, b = i.focus === calculate_active_index/* Focus */.T.Specific ? i.idx : (0,calculate_active_index/* calculateActiveIndex */.d)(i, {
                resolveItems: ()=>p,
                resolveActiveIndex: ()=>{
                    var v, m;
...
class O extends machine/* Machine */.J {
    static new(param) {
    ...
    reduce(e, n) {
        return (0,match/* match */.E)(n.type, D, e, n);
    }
    constructor(e){
        super(e);
        c(this, "actions", {
...
const combobox_machine_glue_u = /*#__PURE__*/ (0,react.createContext)(null);
function p(n) {
    let o = (0,react.useContext)(combobox_machine_glue_u);
    if (o === null) {
...
let de = /*#__PURE__*/ (0,react.createContext)(null);
de.displayName = "ComboboxDataContext";
function ae(C) {
    let h = (0,react.useContext)(de);
    if (h === null) {
...
let Me = /*#__PURE__*/ (0,react.createContext)(null);
function vo(C) {
    let h = p("VirtualProvider"), e = ae("VirtualProvider"), { options: o } = e.virtual, A = (0,react_glue/* useSlice */.M)(h, (a)=>a.optionsElement), [R, v] = (0,react.useMemo)(()=>{
        let a = A;
        if (!a) return [
            0,
            0
        ...
        overscan: 12
    }), [I, m] = (0,react.useState)(0);
    (0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{
        m((a)=>a + 1);
    }, [
        o
    ]);
    let g = T.getVirtualItems(), n = (0,react_glue/* useSlice */.M)(h, (a)=>a.activationTrigger === F.Pointer), f = (0,react_glue/* useSlice */.M)(h, h.selectors.activeOptionIndex);
    return g.length === 0 ? null : /*#__PURE__*/ react.createElement(Me.Provider, {
        value: T
        ...
        return /*#__PURE__*/ react.createElement(react.Fragment, {
            key: a.key
        }, /*#__PURE__*/ react.cloneElement((u = C.children) == null ? void 0 : u.call(C, {
            ...C.slot,
            option: o[a.index]
        }), {
...
let Po = react.Fragment;
function Eo(C, h) {
    let e = (0,react.useId)(), o = (0,disabled/* useDisabled */.B)(), { value: A, defaultValue: R, onChange: v, form: T, name: I, by: m, invalid: g = !1, disabled: n = o || !1, onClose: f, __demoMode: a = !1, multiple: u = !1, immediate: S = !1, virtual: d = null, nullable: k, ...W } = C, y = (0,use_default_value/* useDefaultValue */.L)(R), [x = u ? [] : void 0, P] = (0,use_controllable/* useControllable */.q)(A, v, y), b = combobox_machine_glue_b({
        id: e,
        virtual: d,
        __demoMode: a
    }), G = (0,react.useRef)({
        static: !1,
        hold: !1
    }), _ = (0,use_by_comparator/* useByComparator */.J)(m), z = (0,use_event/* useEvent */.z)((s)=>d ? m === null ? d.options.indexOf(s) : d.options.findIndex((c)=>_(c, s)) : b.state.options.findIndex((c)=>_(c.dataRef.current.value, s))), U = (0,react.useCallback)((s)=>(0,match/* match */.E)(r.mode, {
            [combobox_machine_M.Multi]: ()=>x.some((c)=>_(c, s)),
            [combobox_machine_M.Single]: ()=>_(x, s)
        }), [
        x
    ]), w = (0,react_glue/* useSlice */.M)(b, (s)=>s.virtual), j = (0,use_event/* useEvent */.z)(()=>f == null ? void 0 : f()), r = (0,react.useMemo)(()=>({
            __demoMode: a,
            immediate: S,
            optionsPropsRef: G,
            value: x,
            ...
            disabled: n,
            invalid: g,
            mode: u ? combobox_machine_M.Multi : combobox_machine_M.Single,
            virtual: d ? w : null,
            onChange: P,
            isSelected: U,
            calculateIndex: z,
    ...
    (0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{
        var s;
        d && b.send({
            type: combobox_machine_.UpdateVirtualConfiguration,
            options: d.options,
    ...
    let [M, X, i, H] = (0,react_glue/* useSlice */.M)(b, (s)=>[
            s.comboboxState,
            s.buttonElement,
            s.inputElement,
            s.optionsElement
        ]), q = stack_machine/* stackMachines */.n.get(null), Q = (0,react_glue/* useSlice */.M)(q, (0,react.useCallback)((s)=>q.selectors.isTop(s, e), [
        q,
        e
    ]));
    (0,use_outside_click/* useOutsideClick */.O)(Q, [
        X,
        i,
        H
    ], ()=>b.actions.closeCombobox());
    let Y = (0,react_glue/* useSlice */.M)(b, b.selectors.activeOptionIndex), $ = (0,react_glue/* useSlice */.M)(b, b.selectors.activeOption), be = (0,react.useMemo)(()=>({
            open: M === combobox_machine_C.Open,
            disabled: n,
            invalid: g,
            activeIndex: Y,
            activeOption: $,
        ...
        $,
        M
    ]), [Z, te] = (0,label/* useLabels */.bE)(), t = h === null ? {} : {
        ref: h
    }, B = (0,react.useCallback)(()=>{
    ...
    }, /*#__PURE__*/ react.createElement(floating/* FloatingProvider */.HO, null, /*#__PURE__*/ react.createElement(de.Provider, {
        value: r
    }, /*#__PURE__*/ react.createElement(combobox_machine_glue_u.Provider, {
        value: b
    }, /*#__PURE__*/ react.createElement(open_closed/* OpenClosedProvider */.up, {
        value: (0,match/* match */.E)(M, {
            [combobox_machine_C.Open]: open_closed/* State */.ZM.Open,
            [combobox_machine_C.Closed]: open_closed/* State */.ZM.Closed
        })
    }, I != null && /*#__PURE__*/ react.createElement(form_fields/* FormFields */.Mt, {
        disabled: n,
        data: x != null ? {
            [I]: x
        } : {},
...
function ho(C, h) {
    var Z, te;
    let e = p("Combobox.Input"), o = ae("Combobox.Input"), A = (0,react.useId)(), R = (0,id/* useProvidedId */.Q)(), { id: v = R || "headlessui-combobox-input-".concat(A), onChange: T, displayValue: I, disabled: m = o.disabled || !1, autoFocus: g = !1, type: n = "text", ...f } = C, [a] = (0,react_glue/* useSlice */.M)(e, (t)=>[
            t.inputElement
        ]), u = (0,react.useRef)(null), S = (0,use_sync_refs/* useSyncRefs */.T)(u, h, (0,floating/* useFloatingReference */.AZ)(), e.actions.setInputElement), d = (0,use_owner/* useOwnerDocument */.i)(a), [k, W] = (0,react_glue/* useSlice */.M)(e, (t)=>[
            t.comboboxState,
            t.isTyping
        ]), y = (0,use_disposables/* useDisposables */.G)(), x = (0,use_event/* useEvent */.z)(()=>{
    ...
    use_watch_m((param, param1)=>{
        ...
        let c = u.current;
        c && ((s === combobox_machine_C.Open && B === combobox_machine_C.Closed || t !== E) && (c.value = t), requestAnimationFrame(()=>{
        ...
        if (t === combobox_machine_C.Open && B === combobox_machine_C.Closed) {
            if (e.state.isTyping) return;
            let E = u.current;
            if (!E) return;
    ...
    let b = (0,react.useRef)(!1), G = (0,use_event/* useEvent */.z)(()=>{
        b.current = !0;
    }), _ = (0,use_event/* useEvent */.z)(()=>{
        y.nextFrame(()=>{
            b.current = !1;
        });
        ...
        switch(e.actions.setIsTyping(!0), t.key){
            ...
            case keyboard/* Keys */.R.Escape:
                return e.state.comboboxState !== combobox_machine_C.Open ? void 0 : (t.preventDefault(), e.state.optionsElement && !o.optionsPropsRef.current.static && t.stopPropagation(), o.mode === combobox_machine_M.Single && o.value === null && x(), e.actions.closeCombobox());
            case keyboard/* Keys */.R.Tab:
                if (e.state.comboboxState !== combobox_machine_C.Open) return;
                o.mode === combobox_machine_M.Single && e.state.activationTrigger !== F.Focus && e.actions.selectActiveOption(), e.actions.closeCombobox();
                break;
        }
    }), U = (0,use_event/* useEvent */.z)((t)=>{
        T == null || T(t), o.mode === combobox_machine_M.Single && t.target.value === "" && x(), e.actions.openCombobox();
    }), w = (0,use_event/* useEvent */.z)((t)=>{
        var E, s, c;
        let B = (E = t.relatedTarget) != null ? E : active_element_history_n.find((p)=>p !== t.currentTarget);
        if (!((s = e.state.optionsElement) != null && s.contains(B)) && !((c = e.state.buttonElement) != null && c.contains(B)) && e.state.comboboxState === combobox_machine_C.Open) return t.preventDefault(), o.mode === combobox_machine_M.Single && o.value === null && x(), e.actions.closeCombobox();
    }), j = (0,use_event/* useEvent */.z)((t)=>{
        var E, s, c;
        let B = (E = t.relatedTarget) != null ? E : active_element_history_n.find((p)=>p !== t.currentTarget);
        (s = e.state.buttonElement) != null && s.contains(B) || (c = e.state.optionsElement) != null && c.contains(B) || o.disabled || o.immediate && e.state.comboboxState !== combobox_machine_C.Open && y.microTask(()=>{
            (0,react_dom.flushSync)(()=>e.actions.openCombobox()), e.actions.setActivationTrigger(F.Focus);
        });
    }), r = (0,label/* useLabelledBy */.wp)(), M = (0,description/* useDescribedBy */.zH)(), { isFocused: X, focusProps: i } = (0,useFocusRing/* useFocusRing */.F)({
        autoFocus: g
    }), { isHovered: H, hoverProps: q } = (0,useHover/* useHover */.X)({
        isDisabled: m
    }), Q = (0,react_glue/* useSlice */.M)(e, (t)=>t.optionsElement), Y = (0,react.useMemo)(()=>({
            open: k === combobox_machine_C.Open,
            disabled: m,
            invalid: o.invalid,
            hover: H,
            focus: X,
        ...
        m,
        o.invalid
    ]), $ = (0,render/* mergeProps */.dG)({
        ref: S,
        id: v,
        role: "combobox",
        type: n,
        "aria-controls": Q == null ? void 0 : Q.id,
        "aria-expanded": k === combobox_machine_C.Open,
...
let Ao = "button";
function Io(C, h) {
    let e = p("Combobox.Button"), o = ae("Combobox.Button"), [A, R] = (0,react.useState)(null), v = (0,use_sync_refs/* useSyncRefs */.T)(h, R, e.actions.setButtonElement), T = (0,react.useId)(), { id: I = "headlessui-combobox-button-".concat(T), disabled: m = o.disabled || !1, autoFocus: g = !1, ...n } = C, [f, a, u] = (0,react_glue/* useSlice */.M)(e, (r)=>[
            r.comboboxState,
            r.inputElement,
            r.optionsElement
        ]), S = use_refocusable_input_f(a), d = f === combobox_machine_C.Open;
    (0,use_quick_release/* useQuickRelease */.G)(d, {
        ...
        action: (0,react.useCallback)((r)=>{
            ...
            return dom/* isHTMLElement */.Re(M) ? use_quick_release/* Action */.a.Select(M) : u != null && u.contains(r.target) ? use_quick_release/* Action */.a.Ignore : use_quick_release/* Action */.a.Close;
        }, [
            A,
            a,
            u
    ...
    let k = (0,use_event/* useEvent */.z)((r)=>{
        switch(r.key){
            ...
            case keyboard/* Keys */.R.Enter:
                r.preventDefault(), r.stopPropagation(), e.state.comboboxState === combobox_machine_C.Closed && (0,react_dom.flushSync)(()=>e.actions.openCombobox()), S();
                return;
            case keyboard/* Keys */.R.ArrowDown:
                r.preventDefault(), r.stopPropagation(), e.state.comboboxState === combobox_machine_C.Closed && ((0,react_dom.flushSync)(()=>e.actions.openCombobox()), e.state.dataRef.current.value || e.actions.goToOption({
                    focus: calculate_active_index/* Focus */.T.First
                })), S();
                return;
            case keyboard/* Keys */.R.ArrowUp:
            ...
            case keyboard/* Keys */.R.Escape:
                if (e.state.comboboxState !== combobox_machine_C.Open) return;
                r.preventDefault(), e.state.optionsElement && !o.optionsPropsRef.current.static && r.stopPropagation(), (0,react_dom.flushSync)(()=>e.actions.closeCombobox()), S();
                return;
            default:
                return;
        }
    }), W = (0,use_event/* useEvent */.z)((r)=>{
        r.preventDefault(), !(0,bugs/* isDisabledReactIssue7711 */.P)(r.currentTarget) && (r.button === mouse/* MouseButton */.t.Left && (e.state.comboboxState === combobox_machine_C.Open ? e.actions.closeCombobox() : e.actions.openCombobox()), S());
    }), y = (0,label/* useLabelledBy */.wp)([
        I
    ]), { isFocusVisible: x, focusProps: P } = (0,useFocusRing/* useFocusRing */.F)({
        autoFocus: g
    }), { isHovered: b, hoverProps: G } = (0,useHover/* useHover */.X)({
        isDisabled: m
    }), { pressed: _, pressProps: z } = (0,use_active_press/* useActivePress */.x)({
        disabled: m
    }), U = (0,react.useMemo)(()=>({
            open: f === combobox_machine_C.Open,
            active: _ || f === combobox_machine_C.Open,
            disabled: m,
            invalid: o.invalid,
            value: o.value,
            hover: b,
        ...
        m,
        f
    ]), w = (0,render/* mergeProps */.dG)({
        ref: v,
        id: I,
        type: (0,use_resolve_button_type/* useResolveButtonType */.f)(C, A),
        tabIndex: -1,
        "aria-haspopup": "listbox",
        "aria-controls": u == null ? void 0 : u.id,
        "aria-expanded": f === combobox_machine_C.Open,
        "aria-labelledby": y,
        disabled: m || void 0,
        autoFocus: g,
        onPointerDown: W,
...
let Ro = "div", Do = render/* RenderFeatures */.VN.RenderStrategy | render/* RenderFeatures */.VN.Static;
function _o(C, h) {
    var E, s, c;
    let e = (0,react.useId)(), { id: o = "headlessui-combobox-options-".concat(e), hold: A = !1, anchor: R, portal: v = !1, modal: T = !0, transition: I = !1, ...m } = C, g = p("Combobox.Options"), n = ae("Combobox.Options"), f = (0,floating/* useResolvedAnchor */.Vy)(R);
    f && (v = !0);
    let [a, u] = (0,floating/* useFloatingPanel */.ES)(f), [S, d] = (0,react.useState)(null), k = (0,floating/* useFloatingPanelProps */.U8)(), W = (0,use_sync_refs/* useSyncRefs */.T)(h, f ? a : null, g.actions.setOptionsElement, d), [y, x, P, b, G] = (0,react_glue/* useSlice */.M)(g, (p)=>[
            p.comboboxState,
            p.inputElement,
            p.buttonElement,
            p.optionsElement,
            p.activationTrigger
        ]), _ = (0,use_owner/* useOwnerDocument */.i)(x || P), z = (0,use_owner/* useOwnerDocument */.i)(b), U = (0,open_closed/* useOpenClosed */.oJ)(), [w, j] = (0,use_transition/* useTransition */.Y)(I, S, U !== null ? (U & open_closed/* State */.ZM.Open) === open_closed/* State */.ZM.Open : y === combobox_machine_C.Open);
    (0,use_on_disappear/* useOnDisappear */.m)(w, x, g.actions.closeCombobox);
    let r = n.__demoMode ? !1 : T && y === combobox_machine_C.Open;
    (0,use_scroll_lock/* useScrollLock */.P)(r, z);
    let M = n.__demoMode ? !1 : T && y === combobox_machine_C.Open;
    (0,use_inert_others/* useInertOthers */.s)(M, {
        ...
        n.optionsPropsRef,
        A
    ]), (0,use_tree_walker/* useTreeWalker */.B)(y === combobox_machine_C.Open, {
        container: b,
        accept (p) {
    ...
    let X = (0,label/* useLabelledBy */.wp)([
        P == null ? void 0 : P.id
    ]), i = (0,react.useMemo)(()=>({
            open: y === combobox_machine_C.Open,
            option: void 0
        }), [
        y
    ]), H = (0,use_event/* useEvent */.z)(()=>{
        g.actions.setActivationTrigger(F.Pointer);
    }), q = (0,use_event/* useEvent */.z)((p)=>{
        p.preventDefault(), g.actions.setActivationTrigger(F.Pointer);
    }), Q = (0,render/* mergeProps */.dG)(f ? k() : {}, {
        "aria-labelledby": X,
        role: "listbox",
        "aria-multiselectable": n.mode === combobox_machine_M.Multi ? !0 : void 0,
        id: o,
        ref: W,
        style: {
            ...m.style,
            ...u,
            "--input-width": (0,use_element_size/* useElementSize */.h)(x, !0).width,
            "--button-width": (0,use_element_size/* useElementSize */.h)(P, !0).width
        },
        onWheel: G === F.Pointer ? void 0 : H,
        onMouseDown: q,
        ...(0,use_transition/* transitionDataAttributes */.X)(j)
    }), Y = w && y === combobox_machine_C.Closed, $ = (0,frozen/* useFrozenData */._)(Y, (E = n.virtual) == null ? void 0 : E.options), be = (0,frozen/* useFrozenData */._)(Y, n.value), Z = (0,use_event/* useEvent */.z)((p)=>n.compare(be, p)), te = (0,react.useMemo)(()=>{
    ...
    n.virtual && Object.assign(m, {
        children: /*#__PURE__*/ react.createElement(de.Provider, {
            value: te
        }, /*#__PURE__*/ react.createElement(vo, {
            slot: i
        }, m.children))
    });
    let t = (0,render/* useRender */.L6)(), B = (0,react.useMemo)(()=>n.mode === combobox_machine_M.Multi ? n : {
            ...n,
            isSelected: Z
        }, [
        n,
...
function So(C, h) {
    var r, M, X;
    let e = ae("Combobox.Option"), o = p("Combobox.Option"), A = (0,react.useId)(), { id: R = "headlessui-combobox-option-".concat(A), value: v, disabled: T = (X = (M = (r = e.virtual) == null ? void 0 : r.disabled) == null ? void 0 : M.call(r, v)) != null ? X : !1, order: I = null, ...m } = C, [g] = (0,react_glue/* useSlice */.M)(o, (i)=>[
            i.inputElement
        ]), n = use_refocusable_input_f(g), f = (0,react_glue/* useSlice */.M)(o, (0,react.useCallback)((i)=>o.selectors.isActive(i, v, R), [
        v,
        R
    ])), a = e.isSelected(v), u = (0,react.useRef)(null), S = (0,use_latest_value/* useLatestValue */.E)({
        disabled: T,
        value: v,
        domRef: u,
        order: I
    }), d = (0,react.useContext)(Me), k = (0,use_sync_refs/* useSyncRefs */.T)(h, u, d ? d.measureElement : null), W = (0,use_event/* useEvent */.z)(()=>{
        o.actions.setIsTyping(!1), o.actions.onChange(v);
    });
    (0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>o.actions.registerOption(R, S), [
        S,
        R
    ]);
    let y = (0,react_glue/* useSlice */.M)(o, (0,react.useCallback)((i)=>o.selectors.shouldScrollIntoView(i, v, R), [
        v,
        R
    ]));
    (0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{
        if (y) return (0,disposables/* disposables */.k)().requestAnimationFrame(()=>{
            var i, H;
    ...
    let x = (0,use_event/* useEvent */.z)((i)=>{
        i.preventDefault(), i.button === mouse/* MouseButton */.t.Left && (T || (W(), (0,platform/* isMobile */.tq)() || requestAnimationFrame(()=>n()), e.mode === combobox_machine_M.Single && o.actions.closeCombobox()));
    }), P = (0,use_event/* useEvent */.z)(()=>{
    ...
    }), b = (0,use_tracked_pointer/* useTrackedPointer */.g)(), G = (0,use_event/* useEvent */.z)((i)=>b.update(i)), _ = (0,use_event/* useEvent */.z)((i)=>{
        if (!b.wasMoved(i) || T || f && o.state.activationTrigger === F.Pointer) return;
        let H = e.calculateIndex(v);
        o.actions.goToOption({
            focus: calculate_active_index/* Focus */.T.Specific,
            idx: H
        }, F.Pointer);
    }), z = (0,use_event/* useEvent */.z)((i)=>{
        b.wasMoved(i) && (T || f && (e.optionsPropsRef.current.hold || o.state.activationTrigger === F.Pointer && o.actions.goToOption({
            focus: calculate_active_index/* Focus */.T.Nothing
        })));
    }), U = (0,react.useMemo)(()=>({
            active: f,
...
let Mo = (0,render/* forwardRefWithAs */.yV)(Eo), Lo = (0,render/* forwardRefWithAs */.yV)(Io), Vo = (0,render/* forwardRefWithAs */.yV)(ho), wo = label/* Label */.__, Bo = (0,render/* forwardRefWithAs */.yV)(_o), No = (0,render/* forwardRefWithAs */.yV)(So), wt = Object.assign(Mo, {
    Input: Vo,
    Button: Lo,
    Label: wo,
    Options: Bo,
...
const Search = (t0)=>{
    ...
    if ($[31] !== handleChange || $[32] !== placeholder || $[33] !== props || $[34] !== search) {
        t18 = /* @__PURE__ */ (0,jsx_runtime.jsx)(Vo, {
            spellCheck: false,
            autoComplete: "off",
            type: "search",
            ...props,
    ...
    let t23;
    if ($[53] !== t21 || $[54] !== t22) {
        t23 = /* @__PURE__ */ (0,jsx_runtime.jsx)(Bo, {
            transition: true,
            anchor: t20,
            className: t21,
            children: t22
    ...
    if ($[56] !== handleSelect || $[57] !== t19 || $[58] !== t23) {
        t24 = /* @__PURE__ */ (0,jsx_runtime.jsxs)(wt, {
...
function _temp7(subResult) {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(No, {
        as: api_link["default"],
        value: subResult,
        href: subResult.url,
        className: _temp6,
